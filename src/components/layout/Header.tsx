      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            {/* Logo */}
            <Link href="/" className="font-display text-2xl tracking-wider text-gold">
              MinhLee
            </Link>
            ...
            <button
              ...
              aria-label="Mở menu"
            >
              <span className="block h-px w-6 bg-white transition-all" />
              <span className="block h-px w-6 bg-white transition-all" />
              <span className="block h-px w-4 bg-gold transition-all" />
            </button>
          </div>
        </div>
      </motion.header>
